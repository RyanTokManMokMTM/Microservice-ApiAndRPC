...
type (
	...
	Product struct {
		...
		Desc       string    `db:"desc"`   // product description
		Stock      int64     `db:"stock"`  // product stock
		Amount     int64     `db:"amount"` // amount of product
		Status     int64     `db:"status"` // product status
