...
func (c *orderClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
...
func (UnimplementedOrderServer) Delete(context.Context, *DeleteRequest) (*DeleteResponse, error) {
